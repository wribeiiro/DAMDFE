...
begin
  ...
  TipoImpressao := ParamStr(2);
  CaminhoLogo   := ParamStr(3);
  ...
  // Alteracoes para gerar DAMFE via parametros linha de comando
  ACBrMDFe1.DAMDFe.Logo := CaminhoLogo;

  if TipoImpressao = 'CCE' then // Metodo diferente se for evento
  begin
     ACBrMDFe1.EventoMDFe.Evento.Clear;
     ACBrMDFe1.EventoMDFe.LerXML(CaminhoXML);
  ...
  begin
    ...
    ACBrMDFe1.Manifestos.LoadFromFile(CaminhoXML);
